...
| :--- | :--- | :--- | :--- |
| **Hello Neosantara** | Basic chat completions and model selection | Beginner | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/neosantara-xyz/examples/blob/main/cookbook/beginner/hello-neosantara.ipynb) |
...
| Recipe | Description | Difficulty | Open in Colab |
| :--- | :--- | :--- | :--- |
| **Multimodal OCR** | Extracting data from images using vision models | Advanced | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/neosantara-xyz/examples/blob/main/cookbook/advanced/multimodal-ocr.ipynb) |
