...
1.  Obtain an API Key from the [Neosantara Dashboard](https://api.neosantara.xyz).
...
---
Official Documentation: [docs.neosantara.xyz](https://docs.neosantara.xyz)
